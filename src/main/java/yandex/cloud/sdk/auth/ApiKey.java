...
public class ApiKey implements Credentials {
    ...
    /**
     * Constructs <code>ApiKey</code> object from specified JSON representation of this key
     * @param key API key JSON representation
     */
    public ApiKey(String key) {
        this(convertKeyFromJson(key));
    }
    ...
    private static ServiceAccountKey convertKeyFromJson(String key) {
        ObjectMapper objectMapper = new ObjectMapper();

        try {
            return objectMapper.readValue(key, ServiceAccountKey.class);
